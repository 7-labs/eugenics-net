---
title: "Is Eugenics Pseudoscience?"
...
related: ["what-is-eugenics", "why-eugenics-is-scientifically-wrong", "eugenics-vs-genetics"]
discussionQuestions:
  - "What makes a claim pseudoscientific even when it uses measurements?"
  - "How did eugenicists confuse social labels with hereditary facts?"
  - "Why should ethical failure be discussed alongside scientific failure?"
keyTakeaways:
  - "Eugenics used scientific forms such as charts, tests, and pedigrees while relying on biased categories and unsupported heredity claims."
  - "It oversimplified complex traits and treated social inequality as biological evidence."
  - "Its ethical failure was inseparable from its scientific failure because the research program was organized around hierarchy."
misconceptions:
...
tableOfContents:
  - id: "science-like-forms"
    label: "Science-Like Forms"
  - id: "failed-heredity-claims"
    label: "Failed Claims"
  - id: "ethical-failure"
    label: "Ethical Failure"
  - id: "why-the-label-matters"
    label: "Why the Label Matters"
---
