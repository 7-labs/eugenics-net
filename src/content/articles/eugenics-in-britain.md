...
related: ["francis-galton-and-the-origin-of-eugenics", "eugenics-and-scientific-racism", "teaching-eugenics-responsibly"]
discussionQuestions:
  - "How did British eugenics connect class, empire, heredity, and public reform?"
  - "Why do university archives need critical descriptions of eugenics collections?"
  - "How can teaching avoid turning institutional legacy into celebration?"
keyTakeaways:
  - "British eugenics developed through elite reform, statistics, heredity theory, class anxiety, and imperial context."
  - "UCL's current public work shows how institutions can examine and teach their own eugenic legacies."
  - "The British case shows that eugenics could appear as respectable reform rather than only overt extremism."
misconceptions:
...
tableOfContents:
  - id: "a-respectable-reform-language"
    label: "Reform Language"
  - id: "class-empire-and-measurement"
    label: "Class and Empire"
  - id: "institutional-reckoning"
    label: "Institutional Reckoning"
  - id: "teaching-the-british-case"
    label: "Teaching the Case"
---
