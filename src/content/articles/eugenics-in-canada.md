...
related: ["forced-sterilization-laws", "eugenics-and-disability-rights", "eugenics-in-the-united-states"]
discussionQuestions:
  - "How did provincial law and institutional control shape Canadian eugenics?"
  - "Why are archive projects important for Canadian sterilization history?"
  - "How should survivor-centered framing change the way policies are taught?"
keyTakeaways:
  - "Canadian eugenics was not only imported rhetoric; it operated through provincial laws, institutions, and administrative systems."
  - "Alberta is a central case for understanding sterilization policy and institutional control."
  - "Archive accountability should foreground affected people and avoid treating policies as neutral administration."
misconceptions:
...
tableOfContents:
  - id: "provincial-policy-and-institutions"
    label: "Provincial Policy"
  - id: "alberta-as-a-core-case"
    label: "Alberta"
  - id: "archive-and-survivor-accountability"
    label: "Archive Accountability"
  - id: "comparative-lessons"
    label: "Comparative Lessons"
---
