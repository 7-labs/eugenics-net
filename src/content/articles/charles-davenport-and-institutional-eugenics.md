---
title: "Charles Davenport and Institutional Eugenics"
...
related: ["eugenics-record-office", "eugenics-in-the-united-states", "is-eugenics-pseudoscience"]
discussionQuestions:
  - "How can an institution make biased categories appear scientific?"
  - "What questions should an archive ask about eugenic family records?"
  - "Why is data collection not automatically neutral?"
keyTakeaways:
  - "Davenport's importance lies in institutionalization: research offices, fieldwork, records, training, and policy influence."
  - "The Eugenics Record Office converted social labels into heredity claims and circulated them as expertise."
  - "Responsible archive use requires explaining the power behind the records."
misconceptions:
...
tableOfContents:
  - id: "institutionalizing-eugenics"
    label: "Institutionalizing Eugenics"
  - id: "data-and-family-surveillance"
    label: "Data and Surveillance"
  - id: "archive-responsibility"
    label: "Archive Responsibility"
  - id: "why-institutions-matter"
    label: "Why Institutions Matter"
---
