...
sources:
  - label: "NHGRI: Eugenics and Scientific Racism"
    ...
    note: "Explains the distinction between genetics and eugenic misuse of heredity claims."
  - label: "NHGRI: Genetic Discrimination"
    url: "https://www.genome.gov/about-genomics/policy-issues/genetic-discrimination"
    note: "Official source on genetic discrimination and GINA."
  - label: "UNESCO: Universal Declaration on the Human Genome and Human Rights"
    ...
    note: "Human dignity and non-discrimination principles for genetic knowledge."
  - label: "UNESCO: International Declaration on Human Genetic Data"
    ...
    note: "Ethics framework for human genetic data, privacy, consent, and discrimination."
  - label: "WHO: Human Genome Editing Recommendations"
    url: "https://www.who.int/publications/i/item/9789240030381"
    note: "Governance recommendations for human genome editing."
  - label: "Nuffield Council on Bioethics: Genome Editing and Human Reproduction"
    ...
    note: "Bioethics report on genome editing, reproduction, rights, and social justice."
related: ["what-is-eugenics", "modern-eugenics-debate", "genetic-testing-embryo-selection-ethical-boundaries", "crispr-enhancement-new-eugenics"]
discussionQuestions:
...
faqs:
  - question: "Does criticizing eugenics mean rejecting genetics?"
    answer: "No. Criticizing eugenics means rejecting the misuse of heredity to rank people, deny rights, or control reproduction. Genetics is a scientific field."
  - question: "Can genetic information be used ethically?"
    answer: "Yes, when it is used with consent, privacy, clinical relevance, transparency, equity, and protection against discrimination."
  - question: "When can genetic technology raise eugenics concerns?"
    answer: "It raises eugenics concerns when it is tied to coercion, disability devaluation, racial hierarchy, reproductive pressure, state control, or unequal access."
keyTakeaways:
...
tableOfContents:
  - id: "genetics-is-a-science"
    label: "Genetics"
  - id: "eugenics-was-an-ideology"
    label: "Eugenics"
  - id: "where-the-boundary-can-blur"
    label: "Boundary Risks"
  - id: "genetic-discrimination-and-data"
    label: "Discrimination"
  - id: "modern-bioethics"
    label: "Modern Bioethics"
  - id: "better-public-vocabulary"
    label: "Better Vocabulary"
---
