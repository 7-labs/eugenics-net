...
related: ["eugenics-and-scientific-racism", "eugenics-and-immigration-policy", "eugenics-vs-genetics"]
discussionQuestions:
  - "How did eugenicists turn social categories into claims about biology?"
  - "Why should race not be treated as a ranking of genetic worth?"
  - "How can archives describe racist categories without reproducing their authority?"
keyTakeaways:
  - "Eugenic race claims treated historical and political categories as if they were fixed biological facts."
  - "Race was used to connect immigration, citizenship, health, intelligence, disability, and social value."
  - "Modern genetics does not support racial hierarchy, and human rights do not depend on genetic traits."
misconceptions:
...
tableOfContents:
  - id: "race-as-a-eugenic-category"
    label: "Race as Category"
  - id: "policy-uses"
    label: "Policy Uses"
  - id: "genetics-and-human-dignity"
    label: "Genetics and Dignity"
  - id: "archive-practice"
