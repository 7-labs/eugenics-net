...
sources:
  - label: "NHGRI: Eugenics and Scientific Racism"
    ...
    note: "Defines eugenics as scientifically inaccurate and explains its link to scientific racism."
  - label: "NHGRI: Eugenics Timeline"
    url: "https://www.genome.gov/about-genomics/educational-resources/timelines/eugenics"
    note: "Provides a chronological overview of key terms, institutions, laws, and postwar bioethics developments."
  - label: "United States Holocaust Memorial Museum: Nazi Racial Hygiene"
    ...
    note: "Documents racial hygiene as a state ideology and policy system in Nazi Germany."
  - label: "UNESCO: Universal Declaration on the Human Genome and Human Rights"
    ...
    note: "States human dignity and rights principles relevant to genetic knowledge and discrimination."
  - label: "Cold Spring Harbor Laboratory: Eugenics Record Office"
    ...
    note: "Describes the institutional archive of a major U.S. eugenics research office."
  - label: "UCL: Inquiry into the History of Eugenics at UCL"
    ...
    note: "Shows how universities now examine their institutional connections to eugenics."
related: ["why-eugenics-is-scientifically-wrong", "eugenics-and-scientific-racism", "eugenics-vs-genetics", "forced-sterilization-laws"]
discussionQuestions:
...
faqs:
  - question: "Is this site pro-eugenics?"
    answer: "No. The site documents and critiques eugenics, scientific racism, forced sterilization, and genetic discrimination."
  - question: "Is eugenics the same as genetics?"
    answer: "No. Genetics is a scientific field. Eugenics was an ideology and policy movement that misused heredity and social prejudice to rank people and control reproduction."
  - question: "Why not treat eugenics as a balanced debate?"
    answer: "Because the core eugenic claim that human worth can be ranked and managed through reproduction caused real harms and is not a neutral scientific position."
keyTakeaways:
...
tableOfContents:
  - id: "definition"
    label: "Definition"
  - id: "why-the-claim-failed"
    label: "Why the Claim Failed"
  - id: "positive-and-negative-eugenics"
    label: "Positive and Negative Eugenics"
  - id: "how-it-became-policy"
    label: "How It Became Policy"
  - id: "not-the-same-as-genetics"
    label: "Not the Same as Genetics"
  - id: "responsible-study"
    label: "Responsible Study"
---
