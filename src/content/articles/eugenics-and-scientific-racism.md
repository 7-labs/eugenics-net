...
sources:
  - label: "NHGRI: Eugenics and Scientific Racism"
    ...
    note: "Explains how eugenics and scientific racism used heredity claims to justify hierarchy."
  - label: "NHGRI: Eugenics Timeline"
    url: "https://www.genome.gov/about-genomics/educational-resources/timelines/eugenics"
    note: "Provides historical sequence for eugenics, institutions, laws, and later human-rights responses."
  - label: "United States Holocaust Memorial Museum: Nazi Racial Hygiene"
    ...
    note: "Documents Nazi racial hygiene as a state program built on racial hierarchy."
  - label: "UCL: Inquiry into the History of Eugenics at UCL"
    ...
    note: "Shows institutional reckoning with eugenic research, race science, and university legacies."
  - label: "UNESCO: Universal Declaration on the Human Genome and Human Rights"
    ...
    note: "States human dignity and rights principles against genetic discrimination and reductionism."
  - label: "Cold Spring Harbor Laboratory: Eugenics Record Office"
    ...
    note: "Documents an institutional setting where heredity data collection supported eugenic advocacy."
related: ["what-is-eugenics", "eugenics-and-race", "eugenics-and-immigration-policy", "eugenics-in-nazi-germany"]
discussionQuestions:
  - "What made scientific racism appear authoritative to policy makers?"
  - "Why is race not a simple biological ranking?"
  - "How should educators discuss racist historical claims without normalizing them?"
  - "What responsibilities do archives have when displaying historical measurements and charts?"
faqs:
  - question: "What is scientific racism?"
    answer: "Scientific racism is the use of scientific language, measurement, or institutional authority to justify racial hierarchy. It is not a valid scientific conclusion."
  - question: "How did eugenics use scientific racism?"
    answer: "Eugenicists used racial categories, heredity claims, and biased measurements to argue for exclusion, sterilization, segregation, and national or racial hierarchy."
  - question: "Does modern genetics support racial hierarchy?"
    answer: "No. Human genetic variation does not support the ranking of races as biologically superior or inferior, and rights do not depend on genetic traits."
keyTakeaways:
  - "Scientific racism supplied a vocabulary of measurement and hierarchy; eugenics turned that vocabulary into social and state policy."
  - "Race was treated by eugenicists as if it were a fixed biological ranking, but racial categories are historical, political, and social classifications."
  - "The danger was institutional authority: universities, courts, schools, immigration systems, hospitals, and archives made biased categories appear factual."
  - "A credible archive must explain harmful claims instead of reproducing charts, labels, or classifications as neutral data."
misconceptions:
...
tableOfContents:
  ...
  - id: "measurement-was-not-neutral"
    label: "Measurement Was Not Neutral"
  - id: "race-heredity-and-policy"
    label: "Race, Heredity, and Policy"
  - id: "nazi-racial-hygiene"
    label: "Nazi Racial Hygiene"
  - id: "archive-and-teaching-boundaries"
    label: "Archive and Teaching Boundaries"
---
